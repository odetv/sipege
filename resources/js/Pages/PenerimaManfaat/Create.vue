...
<template>
    <AppLayout
        ...
        subtitle="Formulir pendaftaran kelompok sekolah, lembaga, atau posyandu sasaran gizi"
        :user="user"
        :unit-sppg="unitSppg"
    >
        ...
        <div class="max-w-6xl mx-auto space-y-6 pb-12">
            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    >
                        <Save class="h-4 w-4" />
                        <span>{{ form.processing ? "Menyimpan..." : "Simpan Data Kelompok" }}</span>
                    </button>
                </div>
            </div>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <Card className="bg-white border-slate-200/80 shadow-xs">
                    <CardHeader className="border-b border-slate-100 p-5 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <CardDescription className="text-xs text-slate-500 mt-0.5">
                                    Pemetaan jumlah penerima manfaat Laki-Laki & Perempuan serta jenis porsi ({{ form.kategori || "Pilih Kategori Terlebih Dahulu" }}).
                                </CardDescription>
                            </div>
                        </div>
                    ...
                    <CardContent className="p-5 sm:p-6 space-y-5">
                        ...
                        >
                            ...
                            <span>Silakan pilih <strong>Kategori Jenjang / Lembaga</strong> di bagian 1 terlebih dahulu untuk memunculkan pilihan subkategori.</span>
                        </div>

                        <div v-else class="border border-slate-200 rounded-xl overflow-hidden shadow-2xs">
                        ...
                        <div v-if="form.kategori" class="flex flex-wrap items-center justify-between gap-3 pt-2">
                            <button
                                type="button"
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
                    ...
                    >
                        <Save class="h-4 w-4" />
                        <span>{{ form.processing ? "Menyimpan..." : "Simpan Data Kelompok Penerima Manfaat" }}</span>
                    </button>
                </div>
            </form>
        </div>

            ...
            <div v-if="selectedMenu" class="p-6 space-y-6 max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center gap-2 border-b border-slate-200">
                    ...
                    >
                        ...
                        <span>1. Resep & Komposisi Bahan ({{ selectedMenu.items?.length || 0 }})</span>
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        ...
                        <span>2. Sasaran Penerima Terjangkau ({{ selectedMenu.kelompoks?.filter(k => k.is_menerima !== false).length || 0 }} Menerima, {{ selectedMenu.kelompoks?.filter(k => k.is_menerima === false).length || 0 }} Tidak Menerima)</span>
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        ...
                        <span>3. Evaluasi Nutrisi & AKG</span>
                    </button>
                </div>
                ...
                <div class="pt-4 border-t border-slate-100 flex items-center justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <button
                            v-if="selectedMenu.status_wo === 'Draft' || selectedMenu.status_wo === 'Ditolak'"
                            type="button"

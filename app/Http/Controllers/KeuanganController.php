        ...
        if ($unitSppg) {
            ...
            $mapPoItem = function ($po) {
                return [
                    ...
                    'siklus' => $po->workOrder ? $po->workOrder->siklus : 'Hari ke-1',
                    'total_porsi' => $po->workOrder ? $po->workOrder->total_porsi : 0,
                    'porsi_pk' => $po->workOrder ? $po->workOrder->porsi_pk : 0,
                    'porsi_pb' => $po->workOrder ? $po->workOrder->porsi_pb : 0,
                    'energi_pk' => $po->workOrder ? $po->workOrder->energi_pk : 0,
                    'energi_pb' => $po->workOrder ? $po->workOrder->energi_pb : 0,
                    'protein_pk' => $po->workOrder ? $po->workOrder->protein_pk : 0,
                    'protein_pb' => $po->workOrder ? $po->workOrder->protein_pb : 0,
                    'cost_pk' => $po->workOrder ? $po->workOrder->cost_pk : 0,
                    'cost_pb' => $po->workOrder ? $po->workOrder->cost_pb : 0,
